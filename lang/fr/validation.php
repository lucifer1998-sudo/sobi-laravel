...
return [
    ...
    'attributes' => [
        ...
        // Champs propres à Sobi. Le reste de cette liste vient de laravel-lang et
        // se régénère avec `php artisan lang:add`, donc les nôtres restent à part.
        'firstname' => 'prénom',
        'lastname' => 'nom',
        'source' => 'source',
        'apartment' => 'logement',
        'property_id' => 'logement sélectionné',
        'agreed' => 'acceptation des conditions',
        'signature' => 'signature',
        'zip' => 'code postal',
        'own_rent' => 'location ou propriété',
        'monthly_cost' => 'coût mensuel',
        'move_in_date' => "date d'emménagement",
        'move_out_date' => 'date de déménagement',
        'landlord_name' => 'nom du propriétaire',
        'landlord_phone' => 'téléphone du propriétaire',
        'is_student' => 'étudiant',
        'school_name' => "nom de l'établissement",
        'major' => 'filière',
        'enrollment_date' => "date d'inscription",
        'graduation_date' => "date d'obtention du diplôme",
        'monthly_stipend' => 'bourse mensuelle',
        'is_employed' => 'en emploi',
        ...
        'has_past_employer' => 'ancien employeur',
        'past_employer_name' => "nom de l'ancien employeur",
        'past_position' => 'ancien poste',
        'past_supervisor' => 'ancien responsable',
        'past_work_phone' => 'ancien téléphone professionnel',
        'past_monthly_income' => 'ancien revenu mensuel',
        'past_start_date' => 'date de début précédente',
        'past_end_date' => 'date de fin précédente',
        'emergency_name' => "nom du contact d'urgence",
        'emergency_phone' => "téléphone du contact d'urgence",
        'emergency_relation' => "lien avec le contact d'urgence",
        'desired_move_in' => "date d'emménagement souhaitée",
        'desired_move_out' => 'date de déménagement souhaitée',
        'reason_for_moving' => 'motif du déménagement',
        'has_legal_issue' => 'antécédents judiciaires',
        'legal_explanation' => 'explication',
        'pets.*.type' => "type d'animal",
        'pets.*.weight' => 'poids du chien',
    ],
];
