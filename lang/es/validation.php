...
return [
    ...
    'attributes' => [
        ...
        // Campos propios de Sobi. El resto de esta lista viene de laravel-lang y
        // se regenera con `php artisan lang:add`, así que lo nuestro va aparte.
        'firstname' => 'nombre',
        'lastname' => 'apellidos',
        'source' => 'origen',
        'apartment' => 'unidad',
        'property_id' => 'unidad seleccionada',
        'agreed' => 'aceptación de los términos',
        'signature' => 'firma',
        'zip' => 'código postal',
        'own_rent' => 'alquiler o propiedad',
        'monthly_cost' => 'costo mensual',
        'move_in_date' => 'fecha de entrada',
        'move_out_date' => 'fecha de salida',
        'landlord_name' => 'nombre del propietario',
        'landlord_phone' => 'teléfono del propietario',
        ...
        'monthly_stipend' => 'beca mensual',
        'is_employed' => 'empleado',
        ...
        'has_past_employer' => 'empleo anterior',
        'past_employer_name' => 'nombre del empleador anterior',
        'past_position' => 'puesto anterior',
        'past_supervisor' => 'supervisor anterior',
        'past_work_phone' => 'teléfono del trabajo anterior',
        'past_monthly_income' => 'ingresos mensuales anteriores',
        'past_start_date' => 'fecha de inicio anterior',
        'past_end_date' => 'fecha de fin anterior',
        'emergency_name' => 'nombre del contacto de emergencia',
        'emergency_phone' => 'teléfono del contacto de emergencia',
        'emergency_relation' => 'relación con el contacto de emergencia',
        'desired_move_in' => 'fecha de entrada deseada',
        'desired_move_out' => 'fecha de salida deseada',
